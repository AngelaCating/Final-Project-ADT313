  ...
  const handleSearch = useCallback(() => {
    axios({
      ...
      headers: {
        ...
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI4NGRjZDZhMzM5OGViZjVhNDBkOTJlOWUwYjNmZjA2NiIsIm5iZiI6MTczMjAxMzI0MS44ODkwNTM2LCJzdWIiOiI2NzNjNmFmMTYwYjdiM2JjOTRhMGI3ZGQiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.e28NOvNFoqXvazmDOR30DEC62sDxaaANaz-dMx1FaTo',
      },
    }).then((response) => {
